...
mass = [12.0107; 12.0107; 1.00794; 1.00794; 1.00794; 79.904];  %atomic weight of Silicon, required to calculate acceleration from force: F = mass*accelrn 
...
for count=1:totalITERATION
    ...
    [coord,vel,accelrn,PE,KE] = velverlet_compPhys(count,inputVectorType,coord,vel,accelrn,total,1,1,mass);
